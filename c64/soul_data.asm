...
// =============================
// Included by loader.asm OUTSIDE the agent .pseudopc block.
// Edit this file to change the soul. After editing, run make
// and verify the printed length matches PROMPT_LEN in soul.asm.
...
.print "Soul length: " + (soul_text_end - soul_text)
