...
.const GUARD_CODE_LIMIT = $9140
.const EXEC_STAGE_BASE = $9180
.const EXEC_STAGE_LIMIT = EXEC_STAGE_BASE + $80
.const GUARD_USERQ_NOOP = GUARD_CODE_BASE
.const GUARD_USERQ_ENQUEUE = GUARD_CODE_BASE + $03
.const GUARD_USERQ_LOAD = GUARD_CODE_BASE + $3E
.const GUARD_BSOUT_DRAIN = GUARD_CODE_BASE + $9C
