...
.assert "ready code table must stay below memory staging", READY_CODES_LIMIT <= MEM_STAGE_BASE, true
.assert "guarded stop text must stay below memory staging", STATE_STOP_TEXT_LIMIT <= MEM_STAGE_BASE, true
