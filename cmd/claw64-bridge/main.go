...
type BurninCmd struct {
	Scenario string `arg:"" default:"stop-screen" enum:"stop-screen,screen-repeat,direct-exec,overlap-msg,overlap-queue3" help:"Deterministic protocol scenario to run."`
}
