...
type BurninCmd struct {
	Scenario string `arg:"" default:"stop-screen" enum:"stop-screen,screen-repeat,direct-exec,overlap-msg,overlap-queue3,overlap-running2,overlap-running3,overlap-running4,overlap-running5,overlap-running6" help:"Deterministic protocol scenario to run."`
}
